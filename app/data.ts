...
export const WEB_TITLE = 'Chinh - Personal Website'
export const WEB_DESCRIPTION =
  'A personal website showcasing my work and projects.'
export const FOOTER_COPYRIGHT = '© 2025 Tran Vu Dinh Chinh.'
export const FOOTER_LINK = 'https://github.com/username/'

export const NAME = 'Tran Vu Dinh Chinh'
export const JOB_TITLE = 'Student'
